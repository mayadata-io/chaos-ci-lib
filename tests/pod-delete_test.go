...
var _ = Describe("BDD of pod-delete experiment", func() {
	...
	Context("Check for Litmus components", func() {
		...
		It("Should check for creation of runner pod", func() {
			...
			var err error
			var experimentName = "pod-delete"
			var engineName = "engine1"
			...
			err = pkg.InstallRbac(chaosTypes.PodDeleteRbacPath, pkg.GetEnv("APP_NS", "default"), experimentName, chaosTypes.Client)
			...
			err = pkg.EditFile(experimentName+"-ce.yaml", "name: pod-delete", "name: k8s-pod-delete")
