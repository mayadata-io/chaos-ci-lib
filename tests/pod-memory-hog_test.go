...
func TestPodMemoryHog(t *testing.T) {
...
var _ = Describe("BDD of pod-memory-hog experiment", func() {
	...
	Context("Check for Litmus components", func() {
		...
		It("Should check for creation of runner pod", func() {
			...
			var err error
			var experimentName = "pod-memory-hog"
			var engineName = "engine5"
			...
			err = pkg.InstallRbac(chaosTypes.PodMemoryHogRbacPath, pkg.GetEnv("APP_NS", "default"), experimentName, chaosTypes.Client)
